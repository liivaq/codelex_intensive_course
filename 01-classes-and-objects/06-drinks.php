...
echo "Approximately " . $energyDrinks->calculateEnergyDrinkers() . " bought at least one energy drink\n";
echo "Approximately " . $energyDrinks->calculatePreferCitrus() . " of them prefer citrus flavored energy drinks.\n";
